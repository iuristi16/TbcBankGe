...
public class LoansPage {
    ...
    public LoansPage(Page page) {
        ...
        this.consumerLoanSection = page.locator("div.tbcx-pw-cta-section__info")
                .filter(new Locator.FilterOptions()
                        .setHas(page.getByText("მოითხოვე 80 000 ლარამდე თანხა ონლაინ. ეფექტური 18%-დან")));


        this.applayButton = consumerLoanSection.getByRole(AriaRole.BUTTON,
                new Locator.GetByRoleOptions().setName("სესხის მოთხოვნა"));
